...
//不同通信方式默认最大包的长度
#define DNS_COMM_REQUEST_MAXSIZE	384
#define DNS_COMM_REPLY_MAXSIZE		384
#define HTTP_COMM_REQUEST_MAXSIZE	(32 * 1024)
#define HTTP_COMM_REPLY_MAXSIZE		(32 * 1024)
#define TCP_COMM_REQUEST_MAXSIZE	(5 * 1024)
#define TCP_COMM_REPLY_MAXSIZE		(5 * 1024)
#define ICMP_COMM_REQUEST_MAXSIZE	512
#define ICMP_COMM_REPLY_MAXSIZE		512
